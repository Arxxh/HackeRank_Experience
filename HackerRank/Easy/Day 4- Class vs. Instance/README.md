...
**Difficulty:** Easy  
**Topics:** N/A  
**HackerRank URL:** [Day 4: Class vs. Instance](https://www.hackerrank.com/challenges/30-class-vs-instance/problem)
...
* *amIOld()* should perform the following conditional actions: If , print `You are young.`.
